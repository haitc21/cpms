# CPMS AI-Assisted Delivery Workflow
...
For boundary changes, create the schema/example first. Add a failing test demonstrating both valid and invalid input. Decide compatibility and version behavior explicitly. Update OSPS coordination notes before implementation diverges.
