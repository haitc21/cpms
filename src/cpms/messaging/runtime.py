"""CPMS worker runtime: RabbitMQ connection and lifecycle loop."""
...
async def run_worker(
    *,
    ...
    """Connect to RabbitMQ and keep the CPMS worker alive until shutdown.
    ...
    logger.info("cpms worker connected to rabbitmq")
    ...
    try:
        ...
        logger.info("cpms worker disconnected from rabbitmq")
